...
public class ArchivoPronostico {
    ...
    public String getEmpata() {return empata;}
    ...
    public void setGana1(String gana1) {this.gana1 = gana1;}
    public void setEmpata(String empata) {this.empata = empata;}
    public void setGana2(String gana2) {this.gana2 = gana2;}
